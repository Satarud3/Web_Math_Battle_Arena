    ...
    <div className="min-h-screen bg-[#080B11] text-slate-100 flex flex-col md:flex-row font-sans">
      ...
      <aside className="w-full md:w-64 bg-[#0E131F] border-b md:border-b-0 md:border-r border-slate-800 flex flex-col shrink-0">
        ...
        <nav className="p-4 flex-grow flex flex-col gap-1 text-sm font-medium">
          <Link href="/admin" className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg bg-indigo-600/15 text-indigo-400 border border-indigo-500/10 transition-all">
            <LayoutDashboard size={18} />
            <span>Dashboard</span>
          </Link>
          
          <button 
            onClick={() => alert("Fitur Kelola User... (Fase 4/6)")}
          ...
          <button 
            onClick={() => alert("Fitur Kelola Kategori... (Fase 4)")}
            className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-[#131A2B] transition-all text-left bg-transparent border-none cursor-pointer"
          >
            <FolderPlus size={18} />
          ...
          <button 
            onClick={() => alert("Fitur Kelola Soal... (Fase 4)")}
            className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-[#131A2B] transition-all text-left bg-transparent border-none cursor-pointer"
          >
          ...
          <button 
            onClick={() => alert("Fitur Riwayat Match... (Fase 5)")}
            className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-[#131A2B] transition-all text-left bg-transparent border-none cursor-pointer"
          >
            <History size={18} />
          ...
          <Link href="/leaderboard" className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-[#131A2B] transition-all">
            <Star size={18} />
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-red-500/20 text-red-400 text-xs font-bold hover:bg-red-500/10 transition-all cursor-pointer"
          >
            <LogOut size={14} />
      ...
      {/* Main Content Area */}
      <div className="flex-grow p-6 sm:p-8 flex flex-col gap-8 overflow-y-auto">
